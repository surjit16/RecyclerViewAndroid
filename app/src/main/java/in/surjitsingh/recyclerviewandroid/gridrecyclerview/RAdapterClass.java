...
public class RAdapterClass extends RecyclerView.Adapter<RAdapterClass.RecyclerVH> {

    List<Data> dataList;
    Context context;

    RAdapterClass(Context context, List<Data> list) {
    ...
    public RecyclerVH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = layoutInflater.inflate(R.layout.view_grid_rv_list_item, viewGroup, false);
